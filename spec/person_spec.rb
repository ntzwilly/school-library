...
describe Person do
  before :each do
    @person = Person.new(age: 15, name: 'Alex Harley')
  end
  ...
  describe '#new' do
    ...
    context 'with all parameters' do
      person = Person.new(name: 'Tony', age: 17, parent_permission: false)
  ...
  describe '#can_use_services' do
    context 'minors' do
      ...
      it 'should be allowed only with parent permission' do
        person = Person.new(name: 'Tony', age: 17, parent_permission: true)
        expect(person.can_use_services?).to be_truthy
      end
    end

    context 'adults' do
      person = Person.new(name: 'Tony', age: 18, parent_permission: false)
